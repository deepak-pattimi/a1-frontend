const rawBackendUrl = process.env.NEXT_PUBLIC_BACKEND_URL || process.env.NEXT_PUBLIC_API_URL || "https://admin.a1laparoscopyhospital.com";

// Normalize clean base URL without trailing slashes or subpaths
const cleanBackendUrl = rawBackendUrl.replace(/\/+$/, "").replace(/\/api\/client\/?$/, "");

export const ASSETS_URL = cleanBackendUrl;
export const API_URL = `${cleanBackendUrl}/api/client/`;
